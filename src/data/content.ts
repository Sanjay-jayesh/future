...
export const universities: University[] = [
  ...
  },
  {
    ...
    location: 'Tbilisi',
    country: 'Georgia',
    image: 'https://images.pexels.com/photos/11653610/pexels-photo-11653610.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  ...
  },
  {
    ...
    location: 'Montreal',
    country: 'Canada',
    image: 'https://images.pexels.com/photos/259050/pexels-photo-259050.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    programs: ['Medicine (MD)', 'Engineering', 'Law', 'Computer Science', 'Management', 'Arts & Science'],
    tuition: '$20,000 – $45,000 / year',
    rating: 4.8,
    featured: true,
    description: 'McGill University is one of Canada\'s most prestigious institutions, known as the "Harvard of the North." Located in Montreal, it offers world-class research and a highly international student body.',
    highlights: ['Top 30 university worldwide', 'QS World Ranking #30', 'Strong medical & law programs', 'Bilingual city experience'],
    established: '1821',
    students: '40,000+',
  },
  {
    ...
    location: 'Vancouver',
    country: 'Canada',
    image: 'https://images.pexels.com/photos/259535/pexels-photo-259535.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    programs: ['Computer Science', 'Engineering', 'Forestry', 'Business (Sauder)', 'Medicine (MD)', 'Sciences'],
    tuition: '$22,000 – $48,000 / year',
    rating: 4.8,
    featured: false,
    description: 'UBC is a global centre for teaching, learning, and research, consistently ranked among the top 40 universities in the world. Its stunning Vancouver campus is a hub for innovation.',
    highlights: ['Top 40 university worldwide', 'Stunning oceanfront campus', 'Strong co-op & internship programs', 'Post-graduation work permit eligible'],
    established: '1908',
    students: '70,000+',
  },
  {
    ...
    country: 'Uzbekistan',
    image: 'https://images.pexels.com/photos/356040/pexels-photo-356040.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    programs: ['Medicine (MD)', 'Pediatrics', 'Medical Prevention', 'Dentistry', 'Pharmacy', 'Nursing'],
    tuition: '$2,500 – $4,000 / year',
    rating: 4.4,
    featured: false,
    description: 'Tashkent State Medical University is one of Uzbekistan\'s leading medical institutions, offering affordable, WHO-recognised medical education with English-medium programs for international students.',
    highlights: ['WHO recognised', 'English-medium MBBS program', 'Very affordable tuition', 'Clinical training at top hospitals'],
    established: '1935',
    students: '8,000+',
  },
  {
    ...
    country: 'Uzbekistan',
    image: 'https://images.pexels.com/photos/263402/pexels-photo-263402.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    programs: ['Medicine (MD)', 'Dentistry', 'Pharmacy', 'Nursing', 'Medical Ecology'],
    tuition: '$2,200 – $3,800 / year',
    rating: 4.3,
    featured: false,
    description: 'Samarkand State Medical University is a leading medical institution in Central Asia, offering WHO-recognised medical degrees at one of the most affordable tuition rates in the region.',
    highlights: ['WHO & ECFMG recognised', 'English-medium medical program', 'Most affordable MBBS option', 'Historic Silk Road city'],
    established: '1930',
    students: '6,000+',
  },
  {
    ...
    location: 'London',
    country: 'UK',
    image: 'https://images.pexels.com/photos/614710/pexels-photo-614710.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    programs: ['Medicine (MBBS)', 'Engineering', 'Computer Science', 'Law', 'Economics', 'Architecture'],
    tuition: '$25,000 – $50,000 / year',
    rating: 4.8,
    featured: true,
    description: 'UCL is one of the world\'s top universities, located in the heart of London. It is a member of the elite Russell Group and consistently ranks in the global top 10 for research and teaching.',
    highlights: ['Top 10 university worldwide', 'Russell Group member', 'World-class research facilities', '2-year post-study work visa'],
    established: '1826',
    students: '45,000+',
  },
  {
    ...
    programs: ['Medicine (MBBS)', 'Engineering', 'Computer Science', 'Business', 'Law', 'Sciences'],
    tuition: '$23,000 – $45,000 / year',
    rating: 4.7,
    featured: false,
    description: 'The University of Manchester is a prestigious Russell Group university known for its research excellence and vibrant student life. It has produced 25 Nobel Prize laureates.',
    highlights: ['Russell Group member', '25 Nobel laureates', 'Strong industry connections', 'Post-study work visa eligible'],
    established: '1824',
    students: '40,000+',
  },
  {
    ...
    location: 'Edinburgh',
    country: 'UK',
    image: 'https://images.pexels.com/photos/2837909/pexels-photo-2837909.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    programs: ['Medicine (MBChB)', 'Veterinary Medicine', 'Computer Science', 'Law', 'Business', 'Arts & Humanities'],
    tuition: '$24,000 – $48,000 / year',
    rating: 4.7,
    featured: false,
    description: 'The University of Edinburgh is one of Scotland\'s oldest and most prestigious universities, consistently ranked in the global top 20. It offers world-class programs in a historic and beautiful city.',
    highlights: ['Top 20 university worldwide', 'Founded in 1583', 'Strong medical & vet programs', 'Post-study work visa eligible'],
    established: '1583',
    students: '45,000+',
  },
  {
    ...
    country: 'UK',
    image: 'https://images.pexels.com/photos/2104882/pexels-photo-2104882.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    programs: ['Automotive Engineering', 'Business', 'Computer Science', 'Aerospace Engineering', 'Nursing', 'Media & Communications'],
    tuition: '$16,000 – $22,000 / year',
    rating: 4.5,
    featured: true,
    description: 'Coventry University is a modern, forward-thinking institution known for its strong industry links and excellent employability outcomes. It is ranked among the top UK universities for automotive engineering and design.',
    highlights: ['Top 15 UK modern university', 'Strong industry placements', 'State-of-the-art simulation centres', 'Post-study work visa eligible'],
    established: '1992',
    students: '38,000+',
  },
];
