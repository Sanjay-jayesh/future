...
export const universities: University[] = [
  ...
  },
  {
    ...
    rating: 4.5,
    featured: true,
    description: 'SEU Georgian National University is one of the largest private universities in Georgia, offering a wide range of English-taught programs with a strong emphasis on medical and health sciences education.',
