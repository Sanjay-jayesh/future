                        ...
                        <div className="grid lg:grid-cols-2 gap-0">
                            ...
                            <div className="p-8 flex flex-col justify-center">
                                <div className="flex items-center gap-3 text-sm text-gray-400 mb-3">
                                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-primary-600/15 text-primary-400 text-xs font-medium">
                                ...
                                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3 group-hover:text-primary-400 transition-colors">
                                    {featured.title}
                                </h2>
                                <p className="text-gray-400 leading-relaxed mb-5">{featured.excerpt}</p>
                                <p className="text-sm text-gray-500 mb-5">By {featured.author}</p>
                                <span className="inline-flex items-center gap-1 text-primary-400 font-medium text-sm group-hover:gap-2 transition-all">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-10">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2.5 rounded-xl border border-gray-700 bg-gray-800/50 text-gray-200 text-sm w-full lg:w-64 focus:outline-none focus:border-primary-500 focus:bg-gray-800 focus:ring-2 focus:ring-primary-500/20 transition-all"
                            />
                        </div>
                    </div>
                            ...
                            {filtered.map((post, i) => (
                                <div key={post.id} className="card overflow-hidden group cursor-pointer animate-fade-in-up" style={{ animationDelay: `${i * 80}ms` }}>
                                    <div className="relative h-48 overflow-hidden">
                                        ...
                                        <span className="absolute top-3 left-3 px-2.5 py-1 rounded-md bg-black/70 backdrop-blur-sm text-gray-200 text-xs font-medium">
                                            {post.category}
                                        </span>
                                    </div>
                                    <div className="p-5">
                                        ...
                                        <h3 className="font-bold text-white mb-2 group-hover:text-primary-400 transition-colors leading-snug">
                                            {post.title}
                                        </h3>
