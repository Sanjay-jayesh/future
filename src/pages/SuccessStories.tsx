                        ...
                        {successStories.map((story) => (
                            <StaggerItem key={story.id} variants={scaleIn}>
                                <motion.div
                                    ...
                                    className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl transition-shadow duration-300 flex flex-col h-full"
                                >
                                    ...
                                    <div className="p-6 flex flex-col flex-1">
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-semibold text-gray-900">{story.course}</p>
                                                <p className="text-xs text-gray-500">{story.university}</p>
                                            </div>
                                        </div>
                                        <Quote className="w-6 h-6 text-primary-200 mb-2" />
                                        <p className="text-gray-600 text-sm leading-relaxed flex-1">{story.quote}</p>
                                        <div className="mt-4 pt-4 border-t border-gray-50 flex items-center justify-between">
                                            <span className="text-xs text-gray-400">{story.country}</span>
